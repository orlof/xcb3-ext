...
' PUBLIC
' DRAWS THE DEFINED SCREEN AREA WITH A PATTERN OF TWO CHARACTERS THAT ALTERNATE
...
TYPE UiPanel
    ...
    ' PUBLIC
    ' IF PANEL WAS INITIALIZED WITH SAVEBG THE SCREEN BEHIND THE PANEL IS RESTORED
    ...
    ' PUBLIC
    ' SETS THE EVENTS THAT CAN TRIGGER THE EXIT FROM WaitEvent()
    '   UP
    '       IF TRUE, EVENT_UP IS TRIGGERED WHEN FOCUS EXITS THE PANEL TO THE TOP
    '       IF FALSE, EVENT_UP IS NOT TRIGGERED AND FOCUS WRAPS TO THE BOTTOM
    '   DOWN
    '       IF TRUE, EVENT_DOWN IS TRIGGERED WHEN FOCUS EXITS THE PANEL TO THE BOTTOM
    '       IF FALSE, EVENT_DOWN IS NOT TRIGGERED AND FOCUS WRAPS TO THE TOP
    '   LEFT
    '       IF TRUE, EVENT_LEFT IS TRIGGERED WHEN JOYSTICK IS MOVED LEFT
    '       IF FALSE, JOYSTICK LEFT IS IGNORED
    '   RIGHT
    '       IF TRUE, EVENT_RIGHT IS TRIGGERED WHEN JOYSTICK IS MOVED RIGHT
    '       IF FALSE, JOYSTICK RIGHT IS IGNORED
    '   FIRE
    '       IF TRUE, EVENT_FIRE IS TRIGGERED WHEN JOYSTICK FIRE IS PRESSED
    '       IF FALSE, JOYSTICK FIRE IS IGNORED
    ...
    '   CLEARBG
    '       IF TRUE, THE CLIENT AREA IS CLEARED WITH BACKGROUND COLOR
    '       IF FALSE, THE CLIENT AREA IS LEFT INTACT
    ...
    ' SHORTHAND FOR Draw() WITHOUT CLEARING THE CLIENT AREA
    '   FOCUS
    '       IF TRUE, THE PANEL HAS FOCUS AND THE BORDER IS DRAWN WITH FOCUS COLOR
    '       IF FALSE, THE PANEL HAS NO FOCUS AND THE BORDER IS DRAWN WITH NO FOCUS COLOR
    ...
    '   WIDTH - THE WIDTH OF THE PANEL INCLUDING THE BORDER
    '   HEIGHT - THE HEIGHT OF THE PANEL INCLUDING THE BORDER
    ...
    ' ADDS TEXT LEFT ALIGNED TO THE BORDER
    ...
    ' ADDS TEXT LEFT ALIGNED TO GIVEN COORDINATES
    ...
    ' ADDS TEXT RIGHT ALIGNED TO THE BORDER
    '   Y - THE Y COORDINATE OF THE TEXT
    '   TEXT - THE TEXT TO DISPLAY
    '   TEXTCOLOR - THE COLOR OF THE TEXT
    '   FOCUSABLE
    ...
    ' ADDS TEXT RIGHT ALIGNED TO GIVEN COORDINATES
    '   X - THE X COORDINATE OF THE LAST CHARACTER
    '   Y - THE Y COORDINATE OF THE TEXT
    '   TEXT - THE TEXT TO DISPLAY
    '   TEXTCOLOR - THE COLOR OF THE TEXT
    '   FOCUSABLE
    ...
    ' ADDS TEXT CENTERED BETWEEN THE BORDERS
    '   Y - THE Y COORDINATE OF THE TEXT
    '   TEXT - THE TEXT TO DISPLAY
    '   TEXTCOLOR - THE COLOR OF THE TEXT
    '   FOCUSABLE
    ...
    ' ADDS TEXT CENTERED TO THE GIVEN X COORDINATE
    ...
    '   ALLOWREPEAT
    '       IF TRUE, THE EVENT CAN BE REPEATED BY HOLDING THE JOYSTICK POSITION
    '       IF FALSE, THE PREVIOUS EVENT IS NOT REPEATED WITHOUT RELEASING THE JOYSTICK
    ' WHEN THIS METHOD RETURNS, CALLER SHOULD CHECK
    '   UiPanel.Selected - THE SELECTED ROW
    '   UiPanel.Event - THE EVENT TYPE THAT WAS TRIGGERED. ONE OF
    '       EVENT_UP
    '       EVENT_DOWN
    '       EVENT_LEFT
    '       EVENT_RIGHT
