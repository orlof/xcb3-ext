' THIS LIBRARY REQUIRES THAT lib_joy.bas IS INCLUDED IN THE PROJECT
...
' USE THESE IF YOU WANT TO USE RECTANGULAR BORDERS
...
' USE THESE IF YOU WANT TO USE ROUNDED BORDERS
' ONLY AVAILABLE IN UPPER CASE CHARACTER SET
'CONST TOP_LEFT_CORNER       = 112
'CONST TOP_RIGHT_CORNER      = 110
'CONST BOTTOM_LEFT_CORNER    = 109
'CONST BOTTOM_RIGHT_CORNER   = 125
...
' UNCOMMENT THESE IF YOUR PROJECT DOES NOT DEFINE THEM
'CONST FALSE                 = 0
'CONST TRUE                  = 255
